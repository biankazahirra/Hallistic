        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto ml-[90px]">
            ...
            <div class="mr-[60px] items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 opensans font-semibold text-white rounded lg:bg-transparent lg:p-0  tracking-widest" aria-current="page">CONTACT</a>
                    </li>
                    <li>
...
<section class="bg-image w-[1440px] pt-[20] ">
        <div class="flex flex-col p-[110px_0_120px_100px] w-[fit-content] box-sizing-border">
          ...
          <span class="self-start break-words font-['Open_Sans'] font-[var(--body-1-font-weight,400)] text-[18px] leading-[var(--body-1-line-height,1.611)] text-[var(--white-transparent,rgba(255,255,255,0.75))]">
            Kami di Hallistic siap membantu Anda! Jika Anda memiliki pertanyaan tentang<br> layanan kami, butuh bantuan dalam pemesanan gedung, atau ingin memberikan<br> umpan balik, jangan ragu untuk menghubungi kami.
          </span>
        </div>
</section>
...
<section>
    <div class="bg-[#F3ECDC] flex flex-row justify-center p-[100px_0_50px_0] w-[100%] box-sizing-border">
        <div class="flex flex-row justify-center box-sizing-border">
            <!-- Form Section -->
            <div class="shadow-[var(--shadow-shape,0px_10px_25px_0px_rgba(0,0,0,0.07))] rounded-[30px] bg-[var(--white-smoke,#F9F9F9)] m-[100px_60px_0_0] flex flex-col p-[50px_50px_50px_50px] w-[590px] box-sizing-border">
                <div class="m-[0_0_36px_0] inline-block self-start break-words font-['Abril_Fatface'] font-[var(--heading-medium,400)] text-[35px] text-[var(--heading,#2D2D2D)]">
                    Hubungi kami
                </div>
                <form class="flex flex-col w-[fit-content] box-sizing-border" method="post" action="contact1.php">
                    <div class="m-[0_0_30px_0] flex flex-row w-[fit-content] box-sizing-border">
                        <div class="m-[0_30px_0_0] flex flex-col w-[fit-content] box-sizing-border">
                            ...
                            <input type="text" id="nama" name="nama" class="rounded-[30px] bg-[#F1F1F1] p-[20px_20px_20px_20px] w-[490px] box-sizing-border" placeholder="Nama" required>
                        </div>
                    </div>
                    <div class="m-[0_0_30px_0] flex flex-row w-[fit-content] box-sizing-border">
                        <div class="m-[0_30px_0_0] flex flex-col w-[230px] box-sizing-border">
                            ...
                            <input type="email" id="email" name="email" class="rounded-[30px] bg-[#F1F1F1] p-[20px_20px_20px_20px] w-[fit-content] box-sizing-border" placeholder="Alamat e-mail" required>
                        </div>
                        <div class="flex flex-col w-[230px] box-sizing-border">
                            <label class="m-[0_0_10px_0] inline-block self-start break-words font-['Open_Sans'] font-[var(--form-label-font-weight,600)] text-[17px] leading-[var(--form-label-line-height,1.706)] text-[var(--heading,#2D2D2D)]">
                                Subjek
                            </label>
                            <input type="text" id="subjek" name="subjek" class="rounded-[30px] bg-[#F1F1F1] p-[20px_20px_20px_20px] w-[fit-content] box-sizing-border" placeholder="Topik pertanyaan" required>
                        </div>
                    </div>
                    <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                        ...
                        <textarea class="rounded-[30px] bg-[#F1F1F1] p-[20px_20px_75px_20px] w-[490px] box-sizing-border" id="pesan" name="pesan" placeholder="Ketik pesan disini..." required></textarea>
                    </div>
                    <input type="submit" name="create" value="Kirim" class="rounded-[30px] bg-[var(--primary,#588157)] flex justify-center items-center p-[20px] w-[216px] box-sizing-border text-center transition hover:bg-green-600 focus:bg-green-600 active:bg-green-800 opensans text-white">
                </form>
            </div>
            ...
            <div class=" m-[107px_0_121px_0] flex flex-col p-[114px_0_0_0] box-sizing-border">
                <div class=" flex flex-col box-sizing-border">
                    ...
                    <div class="m-[0_0_30px_0] inline-block self-start break-words font-['Abril_Fatface'] font-[var(--heading-big,400)] text-[45px] text-[var(--heading,#2D2D2D)]">
                        Hubungi kami
                    </div>
                    ...
                    <div class="m-[0_0_30px_0] flex flex-row self-start w-[fit-content] items-center box-sizing-border">
                        <div class="m-[0_20px_0_0] inline-block break-words font-['Font_Awesome_6_Free','Roboto_Condensed'] font-[var(--icon-medium,900)] text-[35px] text-[var(--secondary,#A3B18A)]">
                            <img src="../public/asset/map.png" alt="map">
                        </div>
                        <div class="flex flex-col box-sizing-border">
                            <div class="m-[0_0_7px_0] inline-block break-words font-['Abril_Fatface'] font-[var(--heading-small,400)] text-[21px] text-[var(--heading,#2D2D2D)]">
                                Tempat Kami
                            </div>
                            <span class="break-words font-['Open_Sans'] font-[var(--body-1-font-weight,400)] text-[18px] leading-[var(--body-1-line-height,1.611)] text-[var(--body,#6E6E6E)]">
                                Jakarta, Indonesia
                            </span>
                        </div>
                    </div>
                    ...
                    <div class=" m-[0_0_30px_0] flex flex-row self-start w-[fit-content] items-center p-[0_0_14px_0] box-sizing-border">
                        <div class="m-[0_20px_0_0] inline-block break-words font-['Font_Awesome_6_Free','Roboto_Condensed'] font-[var(--icon-medium,900)] text-[35px] text-[var(--secondary,#A3B18A)]">
                        ...
                        <div class="flex flex-col box-sizing-border">
                            ...
                            <span class="break-words font-['Open_Sans'] font-[var(--body-small,400)] text-[15px] text-[var(--body,#6E6E6E)]">
                                hallistic@gmail.com
                            </span>
                        </div>
                    </div>
                    ...
                    <div class=" flex flex-row self-start w-[fit-content] items-center p-[0_12px_23px_0] box-sizing-border">
                        ...
                        <div class="flex flex-col box-sizing-border">
                            <div class="m-[0_0_7px_0] inline-block self-start break-words font-['Abril_Fatface'] font-[var(--heading-small,400)] text-[21px] text-[var(--heading,#2D2D2D)]">
                                Telephone
                            </div>
                            <span class="break-words font-['Open_Sans'] font-[var(--body-1-font-weight,400)] text-[18px] leading-[var(--body-1-line-height,1.611)] text-[var(--body,#6E6E6E)]">
                                ( +62 ) 123 456 789
                ...
                <div class="bg-[url('../assets/images/dot_smoke_11.png')] bg-[50%_50%] bg-cover bg-no-repeat absolute top-[0px] right-[15.6px] w-[115px] h-[74px]"></div>
            </div>
        </div>
    </div>
</section>
