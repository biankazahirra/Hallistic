  ...
  <section
    ...
    <div>
      <div class="flex flex-col items-center w-[1440px] box-sizing-border">
        <div
          class="m-[0_0_55px_0] inline-block break-words font-['Abril_Fatface'] font-[var(--heading-big,400)] text-[45px] text-[var(--heading,#2D2D2D)]">
          Riwayat Pemesanan
        </div>
        <div class="m-[0_0.6px_0_0] flex flex-row justify-between w-[199.4px] box-sizing-border">
          <a href="transaction2.php"
            class="m-[0_10px_0_0] w-[120px] break-words font-['Open_Sans'] font-[var(--accent-1-font-weight,600)] text-[15px] tracking-[var(--accent-1-letter-spacing,2.3px)] var(--accent-1-text-transform, uppercase) text-[#000000]">
            SEKARANG
          </a>
          <a href="#"
            class="break-words font-['Open_Sans'] font-[var(--accent-1-font-weight,600)] text-[15px] tracking-[var(--accent-1-letter-spacing,2.3px)] var(--accent-1-text-transform, uppercase) text-[#588157]">
            SELESAI
          </a>
        </div>
      </div>
    ...
    <div class="bg-[#F3ECDC] flex justify-center p-[46px_0_69px_0] w-full box-sizing-border">
      <div
        class="shadow-[var(--shadow-shape,0px_10px_25px_0px_rgba(0,0,0,0.07))] rounded-[20px] bg-[#FFFFFF] flex flex-col items-center p-[36px_34px_35.8px_44px] box-sizing-border">
        <div class="m-[0_18px_24px_0] flex flex-row justify-between w-full max-w-[796px] box-sizing-border">
          <div class="m-[0_0_8.2px_0] flex flex-col box-sizing-border">
            <div class="flex self-start box-sizing-border">
              <span
                class="break-words font-['Inter'] font-normal text-[21.8px] tracking-[-0.2px] leading-[1.468] text-[#073937]">
            ...
            <div class=" m-[0_0_0_0px] w-[fit-content] box-sizing-border">
              <div class=" flex p-[0_4.8px_0_0] box-sizing-border">
                <div class=" flex flex-row box-sizing-border">
                  ...
                  <span
                    class="m-[0_0.5px_0_0] break-words font-['Inter'] font-bold text-[16.6px] tracking-[0px] leading-[1.681] text-[#073937]">
                    4.3
                  </span>
                  <span
                    class="break-words font-['Inter'] font-normal text-[17.6px] tracking-[0px] leading-[1.587] text-[#073937]">
                    /5 (
                  </span>
                  <div class="m-[3.9px_0_3.1px_0] flex box-sizing-border">
                    <span
                      class="break-words font-['Inter'] font-normal text-[16.5px] underline leading-[1.258] text-[#073937]">
                      999+ reviews
                    </span>
                  </div>
                </div>
                <span
                  class=" right-[0px] bottom-[0px] break-words font-['Inter'] font-normal text-[18px] tracking-[0px] leading-[1.55] text-[#073937]">
                  )
                </span>
                <span
                  class=" right-[0px] bottom-[0px] break-words font-['Inter'] font-normal text-[16.9px] tracking-[0px] leading-[1.653] text-[#073937]">
            ...
            <div class="m-[0_0px_8px_0] flex flex-row w-[fit-content] box-sizing-border">
              <div class="m-[0_12px_0_0] flex box-sizing-border">
                <div class="rounded-[15px] bg-[#EAECE2] flex p-[0_16px_0_12px] box-sizing-border">
                  <span
                    class="break-words font-['Inter'] font-normal text-[11.6px] tracking-[0.1px] leading-[2.581] text-[#073937]">
                    Sound System Umum
                  </span>
                </div>
              </div>
              <div class="flex box-sizing-border">
                <div class="rounded-[15px] bg-[#EAECE2] flex p-[0_8.5px_0_12px] box-sizing-border">
                  <span
                    class="break-words font-['Inter'] font-normal text-[11.4px] tracking-[0.1px] leading-[2.623] text-[#073937]">
                    Kapasitas 500 orang
                  </span>
                </div>
              </div>
        ...
        <div class="flex flex-row w-[fit-content] box-sizing-border">
          <div class="rounded-[15px] m-[0_40px_0.2px_0] flex w-[500px] box-sizing-border">
            <div
              class="bg-[url('../public/asset/worsix.png')]  flex flex-row gap-[0_6px] p-[276.6px_0_16.4px_0] w-[500px] h-[fit-content] box-sizing-border">
            </div>
          </div>
          <div class="flex flex-col box-sizing-border">
            ...
            <div class="m-[0_9.4px_0_0] flex self-center w-[108.6px] box-sizing-border">
              <div
                class="rounded-[1000px] border-[4px_solid_#588157] bg-[#588157] flex justify-center items-center p-[12px_0] w-[108.6px] h-[fit-content] box-sizing-border transition hover:bg-green-600 focus:bg-green-600 active:bg-green-800">
                <a href="review.php"
