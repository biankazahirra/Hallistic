    ...
    <div>
      <div class="flex flex-col items-center w-[1440px] box-sizing-border">
        ...
        <div class="m-[0_0.6px_0_0] flex flex-row justify-between w-[199.4px] box-sizing-border">
          <a href="transaction2.php" class="m-[0_10px_0_0] w-[120px] break-words font-['Open_Sans'] font-[var(--accent-1-font-weight,600)] text-[15px] tracking-[var(--accent-1-letter-spacing,2.3px)] var(--accent-1-text-transform, uppercase) text-[#000000]">
            SEKARANG
          </a>
          <a href="#" class="break-words font-['Open_Sans'] font-[var(--accent-1-font-weight,600)] text-[15px] tracking-[var(--accent-1-letter-spacing,2.3px)] var(--accent-1-text-transform, uppercase) text-[#588157]">
            SELESAI
          </a>
        </div>
      </div>
        ...
        <div class="flex flex-row w-[fit-content] box-sizing-border">
          ...
          <div class="flex flex-col box-sizing-border">
            ...
            <div class="m-[0_9.4px_0_0] flex self-center w-[108.6px] box-sizing-border">
                <div class="rounded-[1000px] border-[4px_solid_#588157] bg-[#588157] flex justify-center items-center p-[12px_0] w-[108.6px] h-[fit-content] box-sizing-border transition hover:bg-green-600 focus:bg-green-600 active:bg-green-800">
                  <a href="review.php" class="break-words font-['Inter'] font-normal text-center leading-[1.561] text-[#F3ECDC] hover:text-[#EAECE2]">
                    Review
                  </a>
                </div>
              </div>
